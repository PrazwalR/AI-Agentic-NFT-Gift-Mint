...
export class GetGiftAction {
    ...
    async getGift(params: GetGiftParams): Promise<Transaction> {
        ...
        const contractAddress: `0x${string}` =  "0xf998134a7810d4E543425c90353bB1c2D0CA3664" // dev TODO
        const donHostedSecretsSlotID:number = 0 // dev TODO
        const donHostedSecretsVersion:number = 1754478082 // dev TODO
        const clSubId:number = 15723 // dev TODO
